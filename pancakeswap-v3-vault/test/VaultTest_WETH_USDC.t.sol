...
contract VaultTest_POL_USDT is Test {
    address internal constant WBNB = 0x82aF49447D8a07e3bd95BD0d56f35241523fBab1;
    address internal constant USDC = 0xaf88d065e77c8cC2239327C5EDb3A432268e5831;
    address internal constant ROUTER = 0x1b81D678ffb9C0263b24A97847620C99d213eB14;
    address internal constant POOL = 0xd9e2a1a61B6E61b275cEc326465d417e52C1b95c;
    address internal constant REWARD_TOKEN = 0x1b896893dfc86bb67Cf57767298b9073D2c1bA2c;
    Vault public vault;
    address public owner = address(0xA11CE);
    address public user1 = address(0xBEEF);
    address public user2 = address(0xCAFE);
    address public user3 = address(0xDEAD);
    address internal constant _POOL = 0xd9e2a1a61B6E61b275cEc326465d417e52C1b95c;
    address internal constant _MASTER_CHEF_V3 = 0x5e09ACf80C0296740eC5d6F643005a4ef8DaA694;
    ...
    function testVaultLifecycle_POL_USDT() public {
        ...
        SwapHelper.singleSwap(WBNB, USDC, amountToSwap, amountOutMinimum, 500, ROUTER, owner);
        ...
        vm.startPrank(owner);
        vault.initializeVault{value: 0.1 ether}(0.1 ether,500e6, 1, 1, tickLower, tickUpper);
        // Assertions
        ...
        vault.zapInSingle{value: 1 ether}(user1, WBNB, 1 ether, 1, 1, 1);
        // assertEq(IERC20(address(vault.token0())).balanceOf(address(vault)), 0);
        // assertEq(IERC20(address(vault.token1())).balanceOf(address(vault)), 0);
