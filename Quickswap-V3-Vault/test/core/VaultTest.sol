...
contract VaultTest is VaultTestBase {
    function InitializeVault(
        ...
        vault.initializeVault{value: nativeAmount}(amount0, amount1, amount0Min, amount1Min, tickLower, tickUpper, pool);
        // Assertions
    ...
    function ZapInSingleTest(
        ...
        vault.zapInSingle{value: nativeAmount}(user, tokenIn, amountIn, amountOutMin, amount0Min, amount1Min);
    ...
    function ZapInDualTest(
        ...
        vault.zapInDual{value: nativeAmount}(user, amount0, amount1, amount0Min, amount1Min);
